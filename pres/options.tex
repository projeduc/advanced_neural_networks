...
%}
\author[ \textbf{\footnotesize\insertframenumber/\inserttotalframenumber} Abdelkrime Aries] %
{Abdelkrime Aries}

%\author[ \textbf{\footnotesize\insertframenumber/\inserttotalframenumber} \hspace*{1.5cm} ESI - ARIES Abdelkrime (2021/2022)] %
%{ARIES Abdelkrime}
%\titlegraphic{\includegraphics[height=1cm]{../img/esi-logo.png}%\hspace*{4.75cm}~

\date{}
%\date{Année universitaire : 2021/2022} %\today
%
%\titlegraphic{%
...
%	\framesubtitle{Licence: CC-BY-NC 4.0}
	...
	\begin{tcolorbox}[colback=cyan,
		...
		\tiny \url{https://creativecommons.org/licenses/by/4.0/}
